...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="navbar-nav">
      ...
      <a class="nav-link" href="showappointment.php"><i class="fas fa-user-injured"></i>Patient Info</a> 
      <a class="nav-link" href="showPrescription.php"><i class="fas fa-prescription-bottle-alt"></i>Prescription</a> 
